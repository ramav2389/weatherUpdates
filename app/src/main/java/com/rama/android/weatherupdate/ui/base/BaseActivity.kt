package com.rama.android.weatherupdate.ui.base
...
import com.rama.android.weatherupdate.di.component.DaggerActivityComponent
...
abstract class BaseActivity<VM : BaseViewModel> : AppCompatActivity() {
    ...
    @LayoutRes
    protected open fun provideLayoutId(): Int = R.layout.activity_main
